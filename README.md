...
[![TapTap](https://img.shields.io/badge/TapTap-已上架-2EA9F0)](https://www.taptap.cn)
[![评分](https://img.shields.io/badge/评分-9.5-FFB84D)](https://www.taptap.cn)

> ⭐ **TapTap 评分 9.5**，欢迎去评分支持！
>
> 游戏已正式上架 TapTap（手机版 + 电脑版），搜索「完蛋我被AI娘包围了」即可找到。
...
本游戏**完全免费**，如果你喜欢这个故事，欢迎在游戏内 **设置 → 为爱发电 → 支持** 扫码支持（微信 / 支付宝）。
每一份支持都会变成新的剧情！

> 定制 galgame：剧本、配音、开发，都可以聊聊，从零到一帮你把故事做成游戏；买断制上架收益五五分。
